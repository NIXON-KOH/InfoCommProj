...
namespace SimulatedDevice
{
    ...
    public class Program
    {
        ...
        private static string s_connectionString = "HostName=IT3681-00-IoTHub.azure-devices.net;DeviceId=IT3681-GP02-DEV01;SharedAccessKey=DHLOzdGc50KK3TK7H9o+huopSYbI0Wmh5eVNJyvT0Gk=";

        public static async Task SendMsg(string token)
        {
            ...
            await SendDeviceToCloudMessagesAsync(cts.Token, token);
        ...
        private static async Task SendDeviceToCloudMessagesAsync(CancellationToken ct, string token)
        {
            // Initial telemetry values


            // IT3681 - To limit the number of messages sent from this simulated device to IoT Hub.
            // This is to avoid the situation where the daily quota of 8000 messages is exceeeded.
            // Note that all project groups are sharing the same Azure IoT Hub, so all messages from
            // the different simulated devices go to the same hub.
