...
{
    public class MainStation : Controller
    {
        private readonly MRTDbContext _context;

        public MainStation(MRTDbContext context)
        {
            _context = context;
        }
        ...
        // GET: Stations1/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Stations1/Create
